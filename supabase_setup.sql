...
-- 7. TẠO BẢNG CÂU HỎI VÀ LIÊN KẾT TÀI LIỆU (QUESTION BANK)
CREATE TABLE IF NOT EXISTS questions (
    ...
    difficulty TEXT CHECK (difficulty IN ('NB', 'TH', 'VD', 'VDC')) DEFAULT 'NB',
...
-- Bật bảo mật RLS cho các bảng câu hỏi
ALTER TABLE questions ENABLE ROW LEVEL SECURITY;
ALTER TABLE material_questions ENABLE ROW LEVEL SECURITY;

-- Chính sách truy cập công khai cho questions và material_questions
CREATE POLICY "Allow public read access for questions" ON questions FOR SELECT TO anon USING (true);
CREATE POLICY "Allow authenticated changes for questions" ON questions FOR ALL TO authenticated USING (true);

CREATE POLICY "Allow public read access for material_questions" ON material_questions FOR SELECT TO anon USING (true);
CREATE POLICY "Allow authenticated changes for material_questions" ON material_questions FOR ALL TO authenticated USING (true);

-- 8. CHÈN DỮ LIỆU MẪU CHO NGÂN HÀNG CÂU HỎI
INSERT INTO questions (id, course_id, chapter_id, lesson_id, difficulty, question_text, options, correct_option, explanation) VALUES
(1, 1, 101, 1001, 'NB', 'Nghiệm của phương trình $x^2 - 5x + 6 = 0$ là:', '["A. $x_1 = 2, x_2 = 3$", "B. $x_1 = -2, x_2 = -3$", "C. $x_1 = 1, x_2 = 6$", "D. $x_1 = -1, x_2 = -6$"]', 0, 'Ta có $\Delta = (-5)^2 - 4 \cdot 1 \cdot 6 = 1 > 0$. Phương trình có hai nghiệm $x_1 = \frac{5+1}{2} = 3, x_2 = \frac{5-1}{2} = 2$.'),
(2, 1, 101, 1001, 'TH', 'Tổng các nghiệm của phương trình $x^2 + 7x - 8 = 0$ bằng:', '["A. $S = 7$", "B. $S = -7$", "C. $S = 8$", "D. $S = -8$"]', 1, 'Theo hệ thức Vi-ét, tổng các nghiệm là $S = -\frac{b}{a} = -\frac{7}{1} = -7$.'),
(3, 1, 101, 1001, 'TH', 'Tích các nghiệm của phương trình $2x^2 - 3x - 5 = 0$ bằng:', '["A. $P = \\frac{5}{2}$", "B. $P = -\\frac{5}{2}$", "C. $P = \\frac{3}{2}$", "D. $P = -\\frac{3}{2}$"]', 1, 'Theo hệ thức Vi-ét, tích các nghiệm là $P = \frac{c}{a} = -\frac{5}{2}$.'),
-- SQL SCRIPT KHỞI TẠO CƠ SỞ DỮ LIỆU TOÁN SMART TRÊN SUPABASE
-- Hướng dẫn: Thầy mở Supabase Dashboard -> chọn mục "SQL Editor" ở cột trái -> nhấn "New Query" -> dán toàn bộ mã này vào và nhấn "Run".
...
(2, 1, 101, 1001, 'TH', 'Tổng các nghiệm của phương trình $x^2 + 7x - 8 = 0$ bằng:', '["A. $S = 7$", "B. $S = -7$", "C. $S = 8$", "D. $S = -8$"]', 1, 'Theo hệ thức Vi-ét, tổng các nghiệm là $S = -\frac{b}{a} = -\frac{7}{1} = -7$.'),
(3, 1, 101, 1001, 'TH', 'Tích các nghiệm của phương trình $2x^2 - 3x - 5 = 0$ bằng:', '["A. $P = \\frac{5}{2}$", "B. $P = -\\frac{5}{2}$", "C. $P = \\frac{3}{2}$", "D. $P = -\\frac{3}{2}$"]', 1, 'Theo hệ thức Vi-ét, tích các nghiệm là $P = \frac{c}{a} = -\frac{5}{2}$.'),
(4, 1, 101, 1001, 'VD', 'Giá trị của $m$ để phương trình $x^2 - 2x + m = 0$ có nghiệm kép là:', '["A. $m = 1$", "B. $m = -1$", "C. $m = 2$", "D. $m = -2$"]', 0, 'Để phương trình có nghiệm kép thì $\Delta'' = (-1)^2 - 1 \cdot m = 0 \Leftrightarrow 1 - m = 0 \Leftrightarrow m = 1$.'),
(5, 1, 101, 1001, 'VDC', 'Cho phương trình $x^2 - 3x + m = 0$. Giá trị của $m$ để phương trình có hai nghiệm $x_1, x_2$ thỏa mãn $x_1^2 + x_2^2 = 5$ là:', '["A. $m = 1$", "B. $m = 2$", "C. $m = -2$", "D. $m = 3$"]', 1, 'Theo Vi-ét: $x_1 + x_2 = 3$, $x_1x_2 = m$. Ta có $x_1^2 + x_2^2 = (x_1+x_2)^2 - 2x_1x_2 = 3^2 - 2m = 9 - 2m$. Theo giả thiết $9 - 2m = 5 \Leftrightarrow 2m = 4 \Leftrightarrow m = 2$.');

-- Reset lại chuỗi ID tự tăng
SELECT setval('questions_id_seq', (SELECT MAX(id) FROM questions));

-- Liên kết các câu hỏi này với material_id = 10109 (Học liệu trắc nghiệm Quiz Test của Bài 1)
INSERT INTO material_questions (material_id, question_id, order_index) VALUES
(10109, 1, 1),
(10109, 2, 2),
(10109, 3, 3),
(10109, 4, 4),
...
-- ==========================================================
-- BẢN NÂNG CẤP v1.1: BỔ SUNG CỘT material_id VÀO BẢNG questions
-- ==========================================================
ALTER TABLE questions ADD COLUMN IF NOT EXISTS material_id INT;
